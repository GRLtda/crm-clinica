...
.day-card { padding: 1rem; border-radius: 1rem; background-color: var(--branco); border: 1px solid #e5e7eb; transition: all 0.2s ease; }
.day-card.closed { background-color: #f9fafb; opacity: 0.7; }
.card-header { display: flex; align-items: center; gap: 0.75rem; margin-bottom: 1rem; }
.day-name { font-weight: 600; color: #374151; }
.card-body { padding-left: 38px; min-height: 40px; display: flex; align-items: center; }
.time-inputs { display: flex; align-items: center; gap: 0.75rem; }
.separator { color: var(--cinza-texto); }
.closed-text { font-weight: 500; color: var(--cinza-texto); width: 100%; }
...
.summary-and-action { display: flex; justify-content: space-between; align-items: center; margin-top: 2rem; padding-top: 2rem; border-top: 1px solid #e5e7eb; }
.hours-summary { display: flex; gap: 2rem; }
...
.action-wrapper { display: flex; align-items: center; gap: 1rem; }
.success-message { color: #10b981; font-weight: 500; }
.save-button { padding: 0.75rem 1.5rem; border-radius: 0.75rem; border: none; background-color: var(--azul-principal); color: var(--branco); font-size: 1rem; font-weight: 600; cursor: pointer; transition: background-color 0.3s ease; }
.save-button:hover { background-color: var(--azul-escuro); }
</style>
